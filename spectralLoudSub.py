...
def stft(sig, frameSize, overlapFac=0.5, window=np.hanning):
    ...
    # commented as python is complaining with floor - changed in int
...
def plotstft(audiopath, binsize=2**10, plotpath=None, colormap="Spectral"):
    ...
    #attempt to read 24bit with wavio
    ...
    title=audiopath[0:len(audiopath)-4]
    fig.suptitle( title + " - Loudness Subtraction")
    ...
    plotpath = audiopath[0:len(audiopath)-4] + "-Subtraction.png"
